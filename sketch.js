...
var player,
  playerRightWalkingAnima,
  playerLeftWalkingAnima,
  playerRightStandingAnima,
  playerLeftStandingAnima;
...
function preload() {
  ...
  playerRightWalkingAnima = loadAnimation(
    "./anime/player/soldier1.png",
    "./anime/player/soldier2.png",
    "./anime/player/soldier3.png",
    "./anime/player/soldier4.png",
    "./anime/player/soldier5.png",
    "./anime/player/soldier6.png"
  );

  //load animation of player when walking left
  playerLeftWalkingAnima = loadAnimation(
    "./anime/player/invertedSoldier1.png",
    "./anime/player/invertedSoldier2.png",
    "./anime/player/invertedSoldier3.png",
    "./anime/player/invertedSoldier4.png",
    "./anime/player/invertedSoldier5.png",
    "./anime/player/invertedSoldier6.png"
  );

  //load animation of player when standing right
  playerRightStandingAnima = loadAnimation("./anime/player/soldier4.png");

  //load animation of player when standing left
  playerLeftStandingAnima = loadAnimation(
    "./anime/player/invertedSoldier4.png"
  );
  */
...
function draw() {
  ...
  if (gameState === 1) {
    ...
    // player.addAnimation("playerWalking", playerRightWalkingAnima);
  ...
  if (gameState === 4) {
    ...
    invis_ground.y = windowHeight / 2 + 305;
    ...
    if (keyDown("d")) {
      ...
      player.x = player.x - 5;
    } else if (keyDown("space") && player.y >= windowHeight / 2 + 200) {
      player.velocityY = -20;
      jumpSound.play();
    }
  ...
  if (gameState === 8) {
    ...
    invis_ground.y = windowHeight / 2 + 320;
  ...
  if (gameState === 2) {
    ...
    textSize(35);
    text("Press 'F5' to return to Main Menu", windowWidth / 2 - 270, windowHeight / 2 + 50);
